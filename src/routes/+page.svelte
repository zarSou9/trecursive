...
<div class="min-h-screen bg-gradient-to-b from-[#151515] to-[#212121] px-5 py-16">
	<div class="mx-auto max-w-[900px]">
		<h1
			class="mb-14 bg-gradient-to-r from-purple-900 via-purple-700 to-purple-900 bg-clip-text text-center text-5xl font-semibold tracking-tight text-transparent sm:text-7xl"
		>
			AI Research Maps
		</h1>
			...
			{#each allTrees as treeDetails}
				...
				>
					<div class="pr-10">
						...
						{#if treeDetails.note}
							<em class="mt-2 block text-sm text-white/60 [&>a]:text-white/60">
					...
					<div
						class="absolute right-6 top-1/2 -translate-y-1/2 rotate-180 fill-white/50 transition-transform duration-300 group-hover:translate-x-1"
					>
						<ArrowLine size="24" />
					</div>
				</a>
